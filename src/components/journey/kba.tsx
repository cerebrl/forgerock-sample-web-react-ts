...
export default function Kba({
  callback,
  inputName = 'KbaCreateCallbackInput',
}: {
  ...
  const inputNameAnswer = Array.isArray(inputArr)
    ? inputArr[1].name
    : undefined;

  function setAnswer(e: ChangeEvent<HTMLInputElement>) {
    /** ***********************************************************************
     * SDK INTEGRATION POINT
  ...
  function setQuestion(e: ChangeEvent<HTMLSelectElement>) {
    /** ***********************************************************************
     * SDK INTEGRATION POINT
     * Summary: SDK callback methods for setting values
     * ------------------------------------------------------------------------
